...
class BamlSyncClient:
    ...
    def ExtractDeDupe(self, graph: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractDeDupe", args={
                "graph": graph,
            })
    ...
    def ExtractGraph(self, graph: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractGraph", args={
                "graph": graph,
            })
...
class BamlStreamClient:
    ...
    def ExtractDeDupe(self, graph: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.DeDupeResult, types.DeDupeResult]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractDeDupe", args={
            "graph": graph,
        })
        return baml_py.BamlSyncStream[stream_types.DeDupeResult, types.DeDupeResult](
          result,
    ...
    def ExtractGraph(self, graph: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.DynamicGraph, types.DynamicGraph]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractGraph", args={
            "graph": graph,
        })
        return baml_py.BamlSyncStream[stream_types.DynamicGraph, types.DynamicGraph](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractDeDupe(self, graph: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractDeDupe", args={
            "graph": graph,
        }, mode="request")
        return result
    def ExtractGraph(self, graph: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractGraph", args={
            "graph": graph,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
